...
<head>
    ...
    <title>print works admin panel - app products</title>
</head>
<body>
        ...
        <section class="form-container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="input-field">
                        ...
                        <input type="text" name="name" maxlength="100" required palceholder=" add product name">
                    </div>
                    <div class="input-field">
                        <labeL>price <sup>*</sup></label>
                        <input type="number" name="price" maxlength="100" required palceholder="product price">
                    </div>
                    <div class="input-field">
                        <labeL>product detail <sup>*</sup></label>
                        <textarea name="content" required maxlength="10000" required placeholder="enter product description"></textarea>
                    </div>
                    <div class="input-field">
