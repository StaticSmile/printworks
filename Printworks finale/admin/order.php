...
$get = $conn->prepare("SELECT status FROM orders WHERE id = ?");
$get->execute([$order_id]);
...
<head>
    ...
    <title>print works admin panel - order placed message's</title>
</head>
<body>
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <div class="detail">
                            ...
                            <p> method : <span><?= $fetch_orders['method']; ?></span>
